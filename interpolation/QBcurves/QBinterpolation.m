function point = QBinterpolation(controlPoints,t,M)
...
%
% o summary
%      Generalization of de casteljau algorithm (see farin - CAGD)
...
%      quadric (the image of the kinematic mapping SE(3)--> IP^7)
...
% these three point are interplated by the QB-curve
%
% t0 = 0;
% t1 =.5;
% t2 = 1;
